...
const AccessoriesRecyclingForm = (props) => {
  ...
  const facilities = ["iEnviroTech Solutions - Hubli", "Best E-waste Recyclers", "Ewaste Hub","Escrappy Recyclers","E-FRIENDLY WASTE RECYCLERS","4R Recycling Pvt Ltd.","Ash Recyclers","Ecoglobe E-waste Recyclers","Sogo Synergy Private Limited","E Hasiru E Waste Recycling Company"];
